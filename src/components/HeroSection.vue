<template>
  <section class="relative w-full aos-init aos-animate" data-aos="zoom-in-up">
    <div class="absolute top-0 inset-x-0 h-64 flex items-start">
      <div
        class="h-24 w-2/3 gb-gradient-to-br from-[#570cac] blur-2xl invisible opacity-40"
      ></div>
      <div
        class="h-24 w-3/5 gb-gradient-to-r from-[#670ccf] blur-2xl opacity-40"
      ></div>
    </div>
    <div
    ...
    >
      ...
      >
        <div class="lg:py-6">
          ...
          >
            I enjoy creating digital experiences that feel as good as they look intuitive, beautiful, and designed to connect with people on every click.
          </p>
          <div
            class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0"
          >
            <!-- <button
              class="border border-[#f59e0b] px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center"
            >
              <div
              ...
              >
                ...
                <a href="/resume.pdf" download="resume.pdf" class="pl-2 text-[#f59e0b]"> Download CV</a>
              </div>
            </button> -->
          </div>
        </div>
        <div class="lg:h-full md:flex">
          <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
            <div class="absolute z-0 top-1/2 -translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#570cac] to-[#f59e0b] blur-2xl"></div>
            <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-[#f59e0b]">
              <img src="../assets/yulyk.jpeg" alt="Hero" width="500" height="auto" loading="lazy" class="w-full h-full rounded-full object-cover">
            </div>
          </div>
        </div>
      </div>
