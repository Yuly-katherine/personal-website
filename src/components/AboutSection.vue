<template>
  <section class="text-white mt-18" id="about">
    <div class="absolute z-0 top-[93rem] inset-x-0 h-64 flex items-start">
      <div
        class="h-24 w-64 bg-gradient-to-br from-[#f59e0b] via-[#ec4899] blur-2xl to-[#570cac] opacity-20"
      ></div>
    </div>
    <div
      class="md:grid md:grid-cols-2 gap-6 items-start py-4 px-4 sm:py-6 xl:px-12 z-1"
    >
    <div data-aos="fade-up" class="aos-init">
        ...
        <div class="space-y-8 py-2 aos-init" data-aos="fade-left">
          <div
      ...
      <div
        class="mt-20 md:mt-0 text-left flex flex-col z-10 h-full aos-init aos-animate"
        data-aos="fade-up"
      >
        <h2 class="text-4xl font-bold text-white md:text-center text-left mb-4">
          More
          <span
            class="text-transparent bg-clip-text bg-gradient-to-r from-[#f59e0b] to-[#ec4899]"
            >About</span
          >
          Me
        </h2>
        <p class="text-base lg:text-lg mt-4 py-2">
           Frontend Developer with experience in Vue.js (Vuex, Pinia) and React (Context API), skilled at building intuitive, functional, and user-focused web applications.
           <br/>
            I value empathy and human warmth as much as technical skills, fostering collaboration and positive team dynamics.
        </p>
      </div>
    </div>
  </section>
